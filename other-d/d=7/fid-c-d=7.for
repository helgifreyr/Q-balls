c  9 NOV 13 
c Q-balls in Minkowski st background  d= 7
...
c			  write(6,*)U1,try
	...
	ff=1.d0-X(I)
     ...
     -  (5*ff**2*r*sn**2*U1x)/con + 
     -  r**2*sn**2*((-2*ff**3*U1x)/con**2 + 
     -     (ff**4*U1xx)/con**2) + ((-3*sn)/cs + 4*cs*sn)*U1y + 
...
c     ICOM  NUMBER OF THE SOLUTION COMPONENT
   ...
   50 continue  
	...
	ff=1-X(I)
       ...
       Vxy11=0
       Vyy11=sn**2
       Vx11=(ff**2*r*(5*con - 2*ff*r)*sn**2)/con**2
       Vy11=(-3*sn)/cs + 4*cs*sn
       V11=
